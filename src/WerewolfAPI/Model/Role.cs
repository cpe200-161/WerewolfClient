...
namespace WerewolfAPI.Model
{
    ...
    public partial class Role :  IEquatable<Role>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Villager for value: Villager
            /// </summary>
        ...
        public Role(long? Id = default(long?), string Name = default(string), string Description = default(string), List<Action> Actions = default(List<Action>), TypeEnum? Type = default(TypeEnum?))
        {
