...
${nuget_cmd} install src/WerewolfAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/WerewolfAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/WerewolfAPI.dll \
-recurse:'src/WerewolfAPI/*.cs' \
-doc:bin/WerewolfAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/WerewolfAPI.dll was created successfully"
fi
